...
int main(int argc,char* argv[]){
	...
	{
		printf("CloseMetricsDevice NULL, error: %d", GetLastError());
		return false;
	}
	...
	{
		printf("OpenMetricsDevice NULL, error: %d", GetLastError());
		return false;
	}
...
void PrintMetricUnits(IMetricSet_1_1* m_MetricSet , std::ostream& os,IMetricSet_1_1* m_MetricSet)
{
