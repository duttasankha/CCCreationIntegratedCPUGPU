...
/*	(void)verbose;*/
	...
	const char *eventUmaskName0[4] ={"llc.reference","llc.miss","mem_load_uops_retired.l3_hit","mem_load_uops_retired.l3_miss"};
	CFG[3] = pfcParseCfg(eventUmaskName0[0]);
	CFG[4] = pfcParseCfg(eventUmaskName0[1]);
	CFG[5] = pfcParseCfg(eventUmaskName0[2]);
	CFG[6] = pfcParseCfg(eventUmaskName0[3]);

	printf("CFG[0]: %"PRIx64"\tCFG[1]: %"PRIx64"\tCFG[2]: %"PRIx64"\tCFG[3]: %"PRIx64"\tCFG[4]: %"PRIx64"\tCFG[4]: %"PRIx64"\tCFG[4]: %"PRIx64"\n",CFG[0],CFG[1],CFG[2],CFG[3],CFG[4],CFG[5],CFG[6]);

	uint64_t temp_val = 100;
		...
		printf("%-37s: %20lld\n", eventUmaskName0[0]		, (sll)CNT[3]);
		printf("%-37s: %20lld\n", eventUmaskName0[1]            , (sll)CNT[4]);
		printf("%-37s: %20lld\n", eventUmaskName0[2]            , (sll)CNT[5]);
		printf("%-37s: %20lld\n", eventUmaskName0[3]            , (sll)CNT[6]);
		printf("\n\n");
...
void libpfcDemoFunc(){
	...
	for(i=0;i<NUMCOUNTS;i+=4){
		...
		printf("sched0: %s \t sched1: %s \t sched2: %s \t sched3: %s \n",sched0,sched1,sched2,sched3);
		...
		printf("CFG[3]: %"PRIx64"\tCFG[4]: %"PRIx64"\tCFG[5]: %"PRIx64"\tCFG[6]: %"PRIx64"\n\n",CFG[3],CFG[4],CFG[5],CFG[6]);
